...
const city = REGIONAL_CITIES.faisalabad
...
export default function CustomPackagingFaisalabadPage() {
  ...
  const regionalJsonLd = {
    ...
    '@type': 'LocalBusiness',
    name: `Prima Packages - Custom Packaging & Textile Labels ${city.cityName}`,
    description: city.metaDescription,
    url: `https://www.primapackages.pk/${city.slug}`,
