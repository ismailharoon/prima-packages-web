        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-5 gap-8 lg:gap-8">
          ...
          <div className="sm:col-span-2 lg:col-span-2 space-y-6">
            ...
            <p className="text-sm leading-relaxed text-cream/60 max-w-sm">
              ...
              boutiques, fashion brands, and businesses that care about first
              impressions.
            </p>
            ...
            <div className="flex gap-4">
              ...
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="text-cream/40 hover:text-[#1877f2] transition-colors duration-300"
                aria-label="Facebook"
              >
                <svg className="h-5 w-5" fill="currentColor" viewBox="0 0 24 24">
              ...
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="text-cream/40 hover:text-white transition-colors duration-300"
                aria-label="TikTok"
              >
                <svg className="h-5 w-5" fill="currentColor" viewBox="0 0 24 24">
                  <path d="M19.59 6.69a4.83 4.83 0 0 1-3.77-4.25V2h-3.45v13.67a2.89 2.89 0 0 1-5.2 1.74 2.89 2.89 0 0 1 2.31-4.64c.298-.002.595.042.88.13V9.4a6.33 6.33 0 0 0-1-.08A6.34 6.34 0 0 0 3 15.66a6.34 6.34 0 0 0 10.82 4.46V11.3a8.16 8.16 0 0 0 5.77 2.27V10.1a4.84 4.84 0 0 1-3.77-3.41z" />
                </svg>
              </a>
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="text-cream/40 hover:text-green-500 transition-colors duration-300"
                aria-label="WhatsApp"
              >
                <svg className="h-5 w-5" fill="currentColor" viewBox="0 0 24 24">
          ...
          <div>
            ...
            <ul className="space-y-3 text-sm text-cream/60">
              ...
              <li>Shop # B-52, Ground Floor, Karim Center, Saddar, Karachi</li>
            </ul>
          </div>
        </div>

        <HairlineDivider dark className="my-6 sm:my-10" />

        {/* Bottom Bar */}
        <div className="flex flex-col sm:flex-row items-center justify-between gap-4 text-xs text-cream/30 tracking-wide">
          <p>&copy; {currentYear} Prima Packages. All rights reserved.</p>
